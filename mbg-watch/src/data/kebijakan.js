/** BGN kebijakan (policies) demo data */
export const kebijakanList = [
  {
  ...
  },
  {
    ...
    status: "Draft",
    desc: "Sosialisasi penggunaan MBG Watch ke warga, guru, dan komite sekolah di 3 kecamatan.",
    prioritas: "Sedang",
  },
  {
...
/** Status → [statusBadgeClass, label] for kebijakan */
export const kebijakanStatusMap = {
